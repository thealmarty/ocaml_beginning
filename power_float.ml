(* power_float.ml Defines a function that take x and n as arguments to calculate the value of x to the power of n. x and n are of type float. n has to be an integer*)
